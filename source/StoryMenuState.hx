...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		...
		['Senpai', 'Roses', 'Thorns'],
		['Tropical-Resort', 'Sweet-Mountain', 'Starlight-Carnival'],
		['Aquarium-Park', 'Planet-Wisp', 'Asteroid-Coaster'],
		['Phase-One', 'Phase-Two']
	];
	...
	var weekNames:Array<String> = [
		...
		"Colorful Journey PT 1",
		"Colorful Journey PT 2",
		"?"
	];
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				if (curWeek == 9)
				{			
					FlxG.switchState(new VideoState('assets/videos/negawisparmor.webm', new PlayState()));
